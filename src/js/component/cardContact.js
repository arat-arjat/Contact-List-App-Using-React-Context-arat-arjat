...
const CardContact = (props) => {
    ...
    const handlerEdit = async () => {
        try {
            actions.currentContactEdit(props.contacto)
            ...
            <div className="row g-0">
                ...
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <button onClick={handlerEdit} className='btn btn-outline-dark float-end' style={{ marginRight: "5px" }}> <i className='fa fa-pen'> </i> </button>
